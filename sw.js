const V='bpos-v3',A=['/','/index.html','/config.js','/manifest.json','/icon.svg','/vendor/qrcode.min.js','/vendor/jsbarcode.min.js','https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2/dist/umd/supabase.js'];
